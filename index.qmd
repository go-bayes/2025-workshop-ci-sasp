...
If you want to be mighty, stick around. After lunch we'll get into estimation of heterogeneous treatment effects, and walk through a data exercise that will show you how to do causal inference with using **causal machine learning**. Despite the highfalutin sound, the approach is useful. You deserve to be empowered. 
...
If you want to do the data exercise, download R and Rstudio (or your favourite IDE -- like neovim or emacs if you're one of the cool kids) and then download the workshop R package (bottom 👇). 

Important: make sure you install the package first, and run through the scripts as we will not pause to deal with your crisis in working your package installation. Reach out before the workshop, or after, if you get stuck. 
