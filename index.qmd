...
If you want a sense of causal inference, the morning is good enough. Causal machine learning + analysis of heterogenity in the afternoon.
:::
...
#| warning: false
#| column: body-outset
#| fig-cap: "Route between the workshop venue (Redmond Barry Building) and Wine Bar Bistro, 333 Lygon Street, Carlton. Do not follow this exact route."
...
::: callout-tip
### A note on pace
Please do not worry if the math or code looks intimidating at first glance. We'll slow everything down.
:::
...
schedule <- tibble(
  ...
  `Learning goals & activities` = c(
    ...
    "Group Activities",
    "Walk through two applied studies from the NZAVS. Zahle Wisely's employer gratitude analysis; then Hannah Robinson's religious service attendance and personality Q&A follows.",
    "Break.",
    "Introduce heterogeneous treatment effects (Conditional Average Treatment Effects) and policy trees; discuss when effects differ across people.",
    "Case study 2; interpret tree-based decision rules useful for obtaining *policies*.",
    "R demonstrahion using causal forests; interpret simulated ATEs and HTEs, graphs, reporting & etc."
  )
)
