...
schedule <- tibble(
  ...
  Session = c(
    ...
    "Coffee break & discussion (you might need to bring your own coffee)",
    "Worked examples: employer gratitude & religious service attendance",
    "Lunch",
  ...
  `Learning goals & activities` = c(
    ...
    "Walk through two applied studies from the NZAVS. First, Zahle Wisely’s employer gratitude analysis; then a deep dive on religious service attendance and personality—drawing directly on the lecture linked under “Workshop Content.” Joint Q&A follows.",
    "Break.",
