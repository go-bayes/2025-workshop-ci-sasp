...
### Lunch · 12:15 pm
We'll regroup at **Wine Bar Bistro (333 Lygon Street, Carlton)**—a quick five-minute walk from Redmond Barry. Lunch is supported by **Templeton Religion Trust Grant 0418** for participants attending the full workshop.
:::
...
leaflet() %>%
  ...
  addMarkers(
    lng = lunch$lng,
    lat = lunch$lat,
    popup = "Wine Bar Bistro<br>333 Lygon Street, Carlton"
  ) %>%
  addPolylines(
