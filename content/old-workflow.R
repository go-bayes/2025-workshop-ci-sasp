# Workflow for causal estimation
# restart
...
if (packageVersion("margot") < "1.0.227") {
  stop(
    "please install margot >= 1.0.227 for this workflow\n
...
# read results back -------------------------------------------------------
models_analysis <- margot::here_read_qs("models_binary_cate", push_mods)
