...
- Sketch a DAG for a real project you are working on. Which arrows are you confident about, and which ones expose gaps in substantive knowledge or data?
- Identify one variable you usually “control for” out of habit. Does the DAG say it is actually a confounder, a collider, or a mediator in your setting?
- When competing plausible DAGs exist, how would you design a robustness plan (multiple models, sensitivity analyses, new measurements) to keep decision makers honest about causal uncertainty?
- Review Neurath’s boat metaphor: what “old beams” (prior beliefs, institutional knowledge) are stabilising your current DAG, and when should they be replaced?
