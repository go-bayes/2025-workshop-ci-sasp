...
\input{/Users/joseph/GIT/latex/latex-talks.tex} \usepackage{graphicx, xcolor} \setkeys{Gin}{width=.95\linewidth,keepaspectratio}
\makeatletter
...
\urlstyle{same}
\hypersetup{
  pdftitle={Self-Inflicted Injuries},
...
\phantomsection\label{part-1-motivating-example}
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{In the 1980s and 1990s estrogen treatments appeared to \textbf{benefit}
postmenopausal women}, toprule=.15mm, coltitle=black, rightrule=.15mm, colback=white, left=2mm, arc=.35mm, colframe=quarto-callout-note-color-frame, breakable, titlerule=0mm, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, title={Experimental Findings: \textbf{opposite of observational findings}}, toprule=.15mm, coltitle=black, rightrule=.15mm, colback=white, left=2mm, arc=.35mm, colframe=quarto-callout-warning-color-frame, breakable, titlerule=0mm, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, opacityback=0]
...
\begin{block}{Our lives are filled with ``What If?'' questions}
\phantomsection\label{our-lives-are-filled-with-what-if-questions}
\pandocbounded{\includegraphics[keepaspectratio]{../images/slidingdoors.jpg}}
\end{block}

\begin{block}{}
\phantomsection\label{section}
\pandocbounded{\includegraphics[keepaspectratio]{../images/frost.jpg}}
\end{block}
...
\emph{What} Error}}
\phantomsection\label{part-2-the-first-self-inflicted-error-the-what-error}
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, toprule=.15mm, coltitle=black, rightrule=.15mm, colback=white, left=2mm, arc=.35mm, colframe=quarto-callout-important-color-frame, breakable, titlerule=0mm, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-important-color!10!white, opacityback=0]
...
\phantomsection\label{error-2-when-time-zero}
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, title={Survivor Bias.}, toprule=.15mm, coltitle=black, rightrule=.15mm, colback=white, left=2mm, arc=.35mm, colframe=quarto-callout-note-color-frame, breakable, titlerule=0mm, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, title={Emulating a target trial with observational data recovers experimental
effects.}, toprule=.15mm, coltitle=black, rightrule=.15mm, colback=white, left=2mm, arc=.35mm, colframe=quarto-callout-note-color-frame, breakable, titlerule=0mm, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0]
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{discussion-points_files/figure-beamer/fig-time-zero-3lines-1.pdf}
...
\phantomsection\label{error-3-who-population-and-heterogeneity}
\begin{block}{Illustration}
\phantomsection\label{illustration}
\end{block}
\end{frame}

\begin{frame}[fragile]{New Zealand Attitudes and Values Study (NZAVS): A
step-by-step workflow for causal inference}
\phantomsection\label{new-zealand-attitudes-and-values-study-nzavs-a-step-by-step-workflow-for-causal-inference}
...
\begin{block}{Three-wave Panel Design: control for baseline exposure and
...
\begin{block}{Target Population: Residents of New Zealand in 2018 had
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{discussion-points_files/figure-beamer/fig-sample-weights-1.pdf}

}

\caption{\label{fig-sample-weights}Census weights for the NZAVS analytic
sample.}
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{discussion-points_files/figure-beamer/fig-combo-weights-1.pdf}

}

\caption{\label{fig-combo-weights}Stabilised inverse probability of
censoring weights.}
...
\begin{block}{Religious Service Intervention}
...
\begin{block}{Histogram Showing Split}
...
\begin{quote}
\emph{Add \texttt{images/2025\_church\_graph\_cut.png} after running the
eligibility workflow
(\texttt{laboratory/workshop-example/01-init-L10.R}).}
\end{quote}

}

\caption{\label{fig-graph-cut}Distribution of monthly religious
attendance (cut at ≥1).}

\end{figure}%
\end{block}

\begin{block}{Love Plot of Propensity Scores}
...
\begin{quote}
\emph{Propensity diagnostics appear once policy-tree scripts export
\texttt{images/2025\_church\_propensity.png}.}
\end{quote}

}

\caption{\label{fig-propensity}Propensity score diagnostic.}

\end{figure}%
\end{block}

\begin{block}{Average Treatment Effect Results:}
...
\begin{frame}[fragile]{Graph ATE}
\phantomsection\label{graph-ate}
\begin{figure}

\centering{

\begin{quote}
\emph{ATE summary plot absent --- run the causal forest workflow
(\texttt{laboratory/workshop-example/03-models-L10-v3.R}) to cache
results.}
\end{quote}

}

\caption{\label{fig-ate}Average treatment effect estimates across
outcomes.}

\end{figure}%

\begin{block}{How Much Better if We Treated by CATE?}
...
\begin{quote}
\emph{Qini curves load from
\texttt{images/2025\_church\_combined\_qini.png} after the heterogeneous
treatment analysis scripts run.}
\end{quote}

}

\caption{\label{fig-qini}Qini curve comparisons for policy targeting.}

\end{figure}%
\end{block}

\begin{block}{Who Should We Treat First? Belonging}
...
\begin{quote}
\emph{Policy tree plot (belonging) will appear once
\texttt{images/2025\_2L\_church\_on\_belonging.png} is generated.}
\end{quote}

}

\caption{\label{fig-policy-belonging}Policy tree: belonging.}

\end{figure}%
\end{block}

\begin{block}{Who Should We Treat First? Charitable Donations}
...
\begin{quote}
\emph{Policy tree plot (charitable donations) loads from
\texttt{images/2025\_2L\_church\_on\_charity\_donations.png} when
available.}
\end{quote}

}

\caption{\label{fig-policy-charity}Policy tree: charitable donations.}
