...
if (packageVersion("margot") < "1.0.231") {
  stop(
    "please install margot >= 1.0.231 for this workflow\n
...
label_mapping_all = list(
  ...
  # "t2_forgiveness_z" = "Forgiveness",
  # "t2_gratitude_z"  = "Gratitude",
  "t2_log_charity_donate_z" = "Donations",
  "t2_log_hours_charity_z" = "Hours Volunteering"
...
nice_outcome_name = "Prosociality"
...
qini_plots$model_t2_belong_z
qini_plots$model_t2_forgiveness_z
qini_plots$model_t2_gratitude_z
qini_plots$model_t2_log_charity_donate_z
qini_plots$model_t2_neighbourhood_community_z
qini_plots$model_t2_support_z # bad idea
