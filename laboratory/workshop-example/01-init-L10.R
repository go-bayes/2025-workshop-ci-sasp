...
var_labels_exposure <- list(
  "religion_church_binary" = "Religious Attendance",
  "religion_church_binary" = "Religious Attendance (binary)"
)
...
# filter using general eligibility conditions -----------------------------------------
...
dat_long_final <- margot::margot_log_transform_vars(
  dat_long_3,
  vars            = c(starts_with("hours_"), "household_inc", "charity_donate"),
  prefix          = "log_",
  keep_original   = FALSE,
...
# religion church not measure in wave 12
