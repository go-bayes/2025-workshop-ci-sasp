...
if (packageVersion("margot") < "1.0.231") {
  stop("please install margot >= 1.0.231 for this workflow\n
...
# check
# again not rel-church missing in 2021
...
df_wide <- margot_wide_machine(
  ...
  imputation_method = "mice", # <- not needed but will make example easier/faseter
