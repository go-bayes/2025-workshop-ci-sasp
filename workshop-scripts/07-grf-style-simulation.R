...
# workshop simulation.
#
# The function below is not yet wired into the workshop flow; keeping
# it in its own script lets us iterate without disturbing the main
# exercises.  Call `simulate_grf_style()` to obtain a tibble with the
# following columns:
